...
# Which backend won at import, per feature. Worth the boot lines: a missing
# wheel or a RUST_ENGINE_OFF entry is otherwise completely silent.
print(f"ENGINE: {iv_engine.engine_info()}", flush=True)
print(f"ENGINE: features = {iv_engine.feature_engines()}", flush=True)
